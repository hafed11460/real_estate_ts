...
// import { Children, Dispatch, ReactNode, createContext, useCallback, useContext, useEffect, useMemo, useReducer } from "react"
...
// const MapPropertyProvider = ({ children }: { children: ReactNode }) => {
...
//     const setPropertyID = (property_id: number) => {
//         dispatch({
...
//             queryParams,
//         }}>
//             <PropertiesDispatchContext.Provider value={{
//                 setCityId,
//                 setPosition,
//                 setSearch,
//                 dispatch,
...
// }
// // export default MapPropertyProvider
