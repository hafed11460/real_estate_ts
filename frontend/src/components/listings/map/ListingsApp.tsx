...
import { clearFilter, selectCurrentPosition, selectQueryParams, setQueryParams } from "features/properties/map/mapSlice";
            ...
            <div className="border bg-white p-2"
                ...
                <div className='d-flex  justify-content-between'>
                    ...
                    {/* <Button size="sm" variant="primary"> */}
                        { query && 
                        <BsFillXCircleFill   role="button" onClick={()=>dispatch(clearFilter())} size={iconSize} />
                        }
                    {/* </Button> */}
                </div>
            </div>
                ...
                <Row className="py-0  ">
                    ...
                    >
                        <div className='position-relative'>
                            ...
                            <div className="">
                                {
                                    data.results.length ? data.results.map((property: IProperty) => (
